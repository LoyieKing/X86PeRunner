...
void StdcallCallConverter::Call(Emulator * emulator, ImportHookData * data)
{
	...
	int ret = func(x86sp[0], x86sp[1], x86sp[2], x86sp[3], x86sp[4], x86sp[5], x86sp[6], x86sp[7], x86sp[8], x86sp[9], x86sp[10], x86sp[11], x86sp[12], x86sp[13], x86sp[14], x86sp[15], x86sp[16], x86sp[17], x86sp[18], x86sp[19]);
